...
export function MatchmakingScreen({
  ...
  return (
    <div
      className="h-dvh flex flex-col items-center justify-center bg-[var(--color-background)] overflow-hidden select-none px-6 gap-8"
    ...
    >
      ...
      {!timedOut ? (
        ...
        <div className="relative flex flex-col items-center gap-5 w-full max-w-xs text-center">
