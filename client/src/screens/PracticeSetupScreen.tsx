    ...
    >
      ...
      <div className="pum-header relative shrink-0 z-10 flex items-center gap-2
        ...
        <button
          onClick={onBack}
          disabled={starting}
          className="flex items-center gap-1 h-10 pl-2 pr-4 rounded-full bg-white/90 backdrop-blur-sm border border-black/[0.08] shadow-md active:scale-95 transition-transform shrink-0 disabled:opacity-40"
        >
